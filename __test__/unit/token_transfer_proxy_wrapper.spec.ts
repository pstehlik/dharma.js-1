...
import { TokenTransferProxy as MockContractArtifacts } from "@pstehlik/dharma-contracts";
...
const TOKEN_TRANSFER_PROXY_ARTIFACTS_PATH =
    "node_modules/@pstehlik/dharma-contracts/artifacts/json/TokenTransferProxy.json";
